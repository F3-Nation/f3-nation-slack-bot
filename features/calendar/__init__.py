...
def get_preblast_action_buttons(has_q: bool = True, event_instance_id: int = None, include_edit_fields: bool = True) -> List[orm.ButtonElement]:
    buttons = [
        orm.ButtonElement(label=":hc: HC/Un-HC", action=actions.EVENT_PREBLAST_HC_UN_HC)
    ]
    ...
    if event_instance_id and include_edit_fields:
        buttons.append(
            orm.ButtonElement(
