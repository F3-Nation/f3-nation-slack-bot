...
VIEW_MAPPER = {
    ...
    actions.CONFIG_SLT_CALLBACK_ID: (slt.handle_config_slt_post, False),
    actions.NEW_POSITION_CALLBACK_ID: (slt.handle_new_position_post, False),
    actions.EDIT_POSITION_CALLBACK_ID: (slt.handle_edit_position_post, False),
...
ACTION_MAPPER = {
    ...
    actions.CONFIG_SLT: (slt.build_config_slt_form, False),
    actions.SLT_LEVEL_SELECT: (slt.build_config_slt_form, False),
    actions.CONFIG_NEW_POSITION: (slt.build_new_position_form, False),
    actions.CONFIG_EDIT_POSITIONS: (slt.build_position_list_form, False),
    actions.POSITION_EDIT_DELETE: (slt.handle_position_edit_delete, False),
